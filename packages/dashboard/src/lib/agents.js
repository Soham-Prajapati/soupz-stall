...
export const SPECIALISTS = [
  ...
  { id: 'design-thinking-coach', name: 'Maya (Design)', icon: BrainCircuit, color: '#EC4899', desc: 'Human-centered design expert', category: 'design'   },
  ...
  { id: 'svgart',          name: 'SVG Artist',    icon: Palette,       color: '#8B5CF6', desc: 'SVG & CSS art generator',          category: 'design'   },
  ...
  { id: 'review-miner',    name: 'Review Miner',  icon: Search,        color: '#3B82F6', desc: 'Extract pain points from reviews', category: 'research' },
  ...
  { id: 'brainstorm',      name: 'Brainstormer',  icon: Zap,           color: '#F59E0B', desc: 'Ideation facilitator',            category: 'strategy' },
  { id: 'planner',         name: 'Planner',       icon: FileText,      color: '#64748B', desc: 'Sprint planning, milestones',      category: 'strategy' },
  { id: 'scrum',           name: 'Scrum Master',  icon: Users,         color: '#64748B', desc: 'Certified Scrum Master',           category: 'strategy' },
  ...
  { id: 'teacher',         name: 'Teacher',       icon: Microscope,    color: '#10B981', desc: 'Patient expert educator',          category: 'content'  },
  ...
  { id: 'master',          name: 'Team Lead',     icon: Target,        color: '#F59E0B', desc: 'Master orchestrator',              category: 'all'      },
  { id: 'orchestrator',    name: 'Orchestrator',  icon: Wrench,        color: '#8B5CF6', desc: 'Multi-agent workflows',            category: 'all'      },
  { id: 'agent-builder',   name: 'Agent Builder', icon: Wrench,        color: '#6366F1', desc: 'Agent architecture specialist',    category: 'all'      },
  { id: 'module-builder',  name: 'Module Builder',icon: Layers,        color: '#3B82F6', desc: 'Module architecture specialist',   category: 'all'      },
  { id: 'workflow-builder',name: 'Workflow Builder',icon: TrendingUp,  color: '#22C55E', desc: 'Workflow design expert',           category: 'all'      },
  { id: 'quick-flow',      name: 'Quick Flow',    icon: Zap,           color: '#F59E0B', desc: 'Rapid lean implementation',        category: 'all'      },
