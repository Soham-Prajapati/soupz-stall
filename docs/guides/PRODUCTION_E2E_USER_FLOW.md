...
2. First action: "Run npx soupz-cli on your machine."
...
- Primary CTA shows command: npx soupz-cli.
- Secondary CTA routes to docs/connect flow.

### 2. Local Daemon Start
- User runs npx soupz-cli.
...
- Remove conflicting CTAs that distract from npx soupz-cli + pair.
